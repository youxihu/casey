...
func (tx *Tx) init() {
	tx.CaseyInspections = NewCaseyInspectionsClient(tx.config)
	tx.CaseyTrigger = NewCaseyTriggerClient(tx.config)
}
...
// applies a query, for example: CaseyInspections.QueryXXX(), the query will be executed
